...
export class ChatErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex items-center justify-center min-h-screen bg-[var(--cream,#FAF9F6)]">
          <div className="text-center max-w-md px-6">
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white text-[#374151] text-sm rounded-lg border border-[#D1D5DB] hover:bg-[#F9FAFB] transition-colors"
              >
