      ...
      <div className="p-9 max-w-[1200px]">
        <div className="animate-pulse space-y-5">
          ...
          <div className="grid grid-cols-2 gap-5 deal-detail-grid">
            <div className="bg-white rounded-[10px] h-[420px]" style={{ border: '1px solid rgba(5,14,36,0.06)' }} />
            <div className="bg-white rounded-[10px] h-[420px]" style={{ border: '1px solid rgba(5,14,36,0.06)' }} />
          </div>
        </div>
      </div>
  ...
  if (error || !deal) {
    return (
      <div className="p-9 max-w-[1200px]">
        ...
        <div className="bg-white rounded-[10px] px-6 py-16 text-center" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
  ...
  return (
    <div className="p-9 max-w-[1200px]">
      ...
      <div className="flex items-start justify-between mb-6 gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
          ...
          {!editMode ? (
            <button
              onClick={startEdit}
              className="flex items-center gap-1.5 bg-white border border-[#D1D5DB] hover:bg-[#F9FAFB] text-[#374151] rounded-[8px] px-4 py-2.5 text-[0.82rem] font-medium cursor-pointer transition-colors"
            >
            ...
            <div className="flex items-center gap-1.5">
              <button
                onClick={saveEdit}
                disabled={savingEdit}
                className="flex items-center gap-1.5 bg-[#2563EB] hover:bg-[#1D4ED8] text-white border-0 rounded-[8px] px-4 py-2.5 text-[0.82rem] font-medium cursor-pointer transition-colors disabled:opacity-60"
              >
            ...
            <div className="relative">
              ...
              {statusDropdownOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-1 bg-white rounded-[10px] shadow-lg z-20 py-1 min-w-[160px]" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
      ...
      {(() => {
        ...
        return (
          <div className="mb-5 px-4 py-3.5 bg-amber-50 border border-amber-200 rounded-[8px] flex items-start gap-2.5">
      ...
      <div className="grid grid-cols-2 gap-5 mb-5 deal-detail-grid">
        ...
        <div className="space-y-5">
          {/* Financials card */}
          <div className="bg-white rounded-[10px] px-5 py-5" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="appearance-none w-full bg-white rounded-[8px] pl-3 pr-8 py-2 text-[0.82rem] text-gray-700 outline-none cursor-pointer"
            ...
            {editingNotes ? (
              <div>
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-white rounded-[8px] px-3 py-2 text-[0.82rem] text-gray-700 outline-none resize-y"
                  style={{ border: '1px solid rgba(5,14,36,0.15)' }}
                  onFocus={(e) => { e.currentTarget.style.borderColor = '#2563EB'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.08)' }}
                  onBlur={(e) => { e.currentTarget.style.borderColor = 'rgba(5,14,36,0.15)'; e.currentTarget.style.boxShadow = 'none' }}
        ...
        <div className="space-y-5">
          <div className="bg-white rounded-[10px] px-5 py-5" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
              ...
              <div className="flex items-center gap-2">
                ...
                {deal.matches.length > 0 && (
                  <div ref={blastRef} className="relative">
                    ...
                    {blastOpen && (
                      <div className="absolute left-0 top-full mt-1 z-20 bg-white rounded-[10px] shadow-lg p-4 min-w-[260px]" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
                ...
                <div className="relative">
                  ...
                  {showSortDropdown && (
                    <>
                      ...
                      <div className="absolute right-0 mt-1 bg-white rounded-[10px] shadow-lg z-20 py-1 min-w-[140px]" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
                        {([
                          ['matchScore', 'Overall'],
                          ['buyBoxScore', 'Buy Box'],
                          ['priceScore', 'Price'],
            ...
            {matching && deal.matches.length > 0 && (
              <div className="flex items-center gap-2 text-[0.82rem] text-[#2563eb] mb-3 px-3 py-2 bg-[#EFF6FF] rounded-[8px]">
            ...
            {deal.matches.length === 0 ? (
              <div className="py-10 text-center">
                ...
                <button
                  onClick={runMatching}
                  disabled={matching}
                  className="inline-flex items-center gap-1.5 bg-[#2563EB] hover:bg-[#1D4ED8] text-white border-0 rounded-[8px] px-4 py-2.5 text-[0.82rem] font-medium cursor-pointer transition-colors disabled:opacity-60"
                >
                  {matching ? <Loader2 className="w-4 h-4 animate-spin" /> : <Users className="w-4 h-4" />}
                  {matching ? 'Matching...' : 'Run Matching'}
                </button>
      ...
      <div className="bg-white rounded-[10px] px-5 py-5" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
        ...
        {/* Record Offer form */}
        {offerFormOpen && (
          <div className="mb-4 p-4 bg-gray-50 rounded-[10px] space-y-3" style={{ border: '1px solid rgba(5,14,36,0.06)' }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full bg-white rounded-[8px] pl-7 pr-3 py-2 text-[0.82rem] text-gray-700 outline-none"
                    style={{ border: '1px solid rgba(5,14,36,0.15)' }}
                    onFocus={(e) => { e.currentTarget.style.borderColor = '#2563EB'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.08)' }}
                    onBlur={(e) => { e.currentTarget.style.borderColor = 'rgba(5,14,36,0.15)'; e.currentTarget.style.boxShadow = 'none' }}
                  />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white rounded-[8px] px-3 py-2 text-[0.82rem] text-gray-700 outline-none"
                  style={{ border: '1px solid rgba(5,14,36,0.15)' }}
                  onFocus={(e) => { e.currentTarget.style.borderColor = '#2563EB'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.08)' }}
                  onBlur={(e) => { e.currentTarget.style.borderColor = 'rgba(5,14,36,0.15)'; e.currentTarget.style.boxShadow = 'none' }}
                />
          ...
          <div className="py-8 text-center">
            ...
            {deal.matches.length > 0 && deal.status !== 'CLOSED' && deal.status !== 'CANCELLED' && (
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-[#2563EB] hover:bg-[#1D4ED8] text-white border-0 rounded-[8px] px-4 py-2.5 text-[0.82rem] font-medium cursor-pointer transition-colors"
              >
                  ...
                  {isExpanded && (
                    <div className="px-1 pb-3 pl-4 space-y-2">
                      ...
                      <div className="space-y-1.5">
                        ...
                        {offer.message && (
                          <div className="text-[0.78rem] text-gray-600 bg-gray-50 rounded-[8px] p-3 mt-1">
                            {offer.message}
                          </div>
                        )}
                      </div>
                      ...
                      {/* Counter form */}
                      {isCountering && (
                        <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-[10px] space-y-2">
                            ...
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full bg-white border border-blue-200 rounded-[8px] pl-6 pr-2 py-1.5 text-[0.78rem] text-gray-700 outline-none focus:border-[#2563EB]"
                                />
                              </div>
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                className="w-full bg-white border border-blue-200 rounded-[8px] px-2 py-1.5 text-[0.78rem] text-gray-700 outline-none focus:border-[#2563EB]"
                              />
                            </div>
                          </div>
                          <div className="flex items-center gap-2 pt-1">
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-white rounded-[8px] ${prefix ? 'pl-7' : 'pl-3'} pr-3 py-2 text-[0.82rem] text-gray-700 outline-none`}
          style={{ border: '1px solid rgba(5,14,36,0.15)' }}
          onFocus={(e) => { e.currentTarget.style.borderColor = '#2563EB'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.08)' }}
          onBlur={(e) => { e.currentTarget.style.borderColor = 'rgba(5,14,36,0.15)'; e.currentTarget.style.boxShadow = 'none' }}
        />
