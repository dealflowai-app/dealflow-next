      ...
      <div className="grid analyzer-input-grid gap-5" style={{ gridTemplateColumns: '1.5fr 1fr' }}>
        ...
        <div>
          ...
          <div className="bg-white border border-[rgba(5,14,36,0.08)] rounded-xl px-5 py-4">
            ...
            <div
              className={`mt-3 pt-3 border-t border-gray-100 transition-colors ${photoDragOver ? 'bg-blue-50 rounded-lg' : ''}`}
            ...
            >
              {photos.length === 0 ? (
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center group-hover:bg-[#EFF6FF] transition-colors flex-shrink-0">
                ...
                <div className="flex items-center gap-2">
                  {photoPreviews.map((url, i) => (
                    <div key={i} className="relative w-10 h-10 rounded-lg overflow-hidden border border-gray-200 flex-shrink-0 group/thumb">
            ...
            <div className="space-y-3">
              {ANALYSIS_FEATURES.map((f) => (
                <div key={f.title} className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${featureIconBg(f.icon)}`}>
              ...
              {photos.length > 0 && (
                <div className="flex items-center gap-3 animate-fadeInUp">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${featureIconBg('camera')}`}>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 pl-6 mb-2">
                    {item.dealGrade && (
                      <span className={`text-[0.64rem] font-bold px-2 py-0.5 rounded-lg border ${gradeColor(item.dealGrade)}`}>
                        {item.dealGrade}
                      </span>
                    )}
          ...
          {aiSummary && (
            <div className="bg-white border border-[rgba(5,14,36,0.08)] rounded-xl px-5 py-5">
              ...
              {aiSummary.recommendation && (
                <p className="text-[0.82rem] text-gray-800 font-medium mb-3 px-3 py-2 bg-gray-50 rounded-lg">
                  {aiSummary.recommendation}
                </p>
              )}
    ...
    <div>
      ...
      {photos.length > 0 && (
        <div className="flex gap-2 mt-3 flex-wrap">
          {previews.map((url, i) => (
            <div key={i} className="relative w-[72px] h-[72px] rounded-lg overflow-hidden border border-gray-200 flex-shrink-0 group">
  ...
  return (
    <div className="bg-white border border-[rgba(5,14,36,0.08)] rounded-xl px-5 py-5">
      ...
      <div className="flex items-center gap-3 mb-3">
        <span className={`text-[0.76rem] font-bold px-2.5 py-1 rounded-lg border ${conditionColor(pa.overallCondition)}`}>
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 mb-3 photo-thumbs-scroll">
          {previews.map((url, i) => (
            <button
              ...
              className={`w-[64px] h-[64px] rounded-lg overflow-hidden flex-shrink-0 border-2 cursor-pointer transition-colors ${
  ...
  return (
    <div className="p-8 max-w-[1200px] bg-[var(--cream,#FAF9F6)]" style={{ fontFamily: "'Satoshi', -apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif" }}>
      ...
      <div className="flex items-start justify-between mb-5">
        ...
        {todayCount > 0 && (
          <div className={`flex items-center gap-1.5 text-[0.76rem] px-3 py-1.5 rounded-lg ${
